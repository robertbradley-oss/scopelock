...
- Public commit: `fbd32b24e4409f2635b6dbc7461e6e2f0783b325`.
- Annotated tag and latest release: `v0.1.1`.
- Release URL: `https://github.com/robertbradley-oss/scopelock/releases/tag/v0.1.1`.
- Release ZIP SHA-256: `74d75c399c2065923f7cb4e76385f5d8e20b153f64011c26ed00d5d2b07d9416`.
- GitHub's asset digest and a freshly downloaded ZIP matched the local archive.
- The temporary `scopelock-phase5-local` marketplace and plugin were removed.
- The canonical public `scopelock@scopelock` plugin was installed and enabled at `0.1.1`.
- A fresh Codex CLI process exposed exactly one ScopeLock package and all three skills from the installed public `0.1.1` cache.
